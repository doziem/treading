...
import com.doziem.treading.repository.CoinRepository;
...
public class CoinService implements ICoinService{
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        ...
        try{
            ...
            return objectMapper.readValue(res.getBody(), new TypeReference<List<Coin>>() {});
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/"+coinId+"/market_chat?vs_currency=usd&days="+ days;
        RestTemplate restTemplate = new RestTemplate();
    ...
    public Coin findById(String coinId) throws Exception {
        ...
        if(optionalCoin.isEmpty())throw new Exception("coin not fount");
